...
#define digitalPin_Sum 54   //toal digital pin number
#define analogPin_Sum 16    //toal analog pin number
...
DynamicJsonDocument recvMsg_doc(500);     // create JsonDocument object to transfer receive string to Json Document
StaticJsonDocument<500> sndMsg_doc;       // create JsonDocument object to store the message sending through software serial
...
bool analysis_message(void)
{
  ...
  if(recvMsg_doc["HD"]== "Arduino_MEGA2560")
      res = update_pinWrite();
